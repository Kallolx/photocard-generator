          ...
          {steps.map((step, index) => (
            <div key={index} className="relative group">
              <div className="relative bg-white rounded-3xl p-8 h-full border border-gray-200 hover:border-transparent hover:shadow-2xl transition-all duration-300">
                ...
                {/* Icon */}
                <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${step.gradient} flex items-center justify-center text-white mb-6 group-hover:shadow-xl transition-shadow`}>
                  {step.icon}
                </div>
                ...
                <div className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r ${step.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-b-3xl`}></div>
              </div>
