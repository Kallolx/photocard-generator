...
export default function HeroSection({ t }: HeroSectionProps) {
  ...
  return (
    <section
      id="home"
      className="relative pt-32 pb-20 px-4 bg-gradient-to-br from-slate-50 via-white to-purple-50 overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[500px] flex items-center justify-center">
            {CARD_GRADIENTS.map((gradient, index) => {
              const offset =
                (index - activeIndex + CARD_GRADIENTS.length) %
                CARD_GRADIENTS.length;
              if (offset > 2 && offset !== CARD_GRADIENTS.length - 1)
                return null;
