        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 bg-[#3d3124] border-2 border-[#5d4e37] flex items-center justify-center hover:bg-[#8b6834] hover:border-[#c19a6b] transition-colors"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
          ...
          <div>
            <h4 className="font-lora font-bold text-lg mb-4 text-[#c19a6b]">
              {t.footer.product}
            </h4>
