...
// ─── Props ────────────────────────────────────────────────────────────────────
interface ClassicIslamicCardProps {
  logo?: string;
  narrator?: string;
  hadisText?: string;
  source?: string;
...
// ─── Component ────────────────────────────────────────────────────────────────
export default function ClassicIslamicCard({
  logo = "",
  ...
  isLogoFavicon = false,
  backgroundImage = "/islamic/1.png",
}: ClassicIslamicCardProps) {
  ...
  return (
    ...
    >
      {/* Content */}
      <div ref={contentRef} style={{ flex: 1, padding: "28px 56px 14px", display: "flex", flexDirection: "column", alignItems: "center", overflow: "hidden" }}>
            ...
            {logo ? (
              <div style={{
                ...
                <img
                  ...
                  alt="Logo"
                  style={{ maxHeight: "34px", maxWidth: "120px", objectFit: "contain", display: "block" }}
              ...
              <div style={{
                ...
                <span style={{ color: GOLD, fontSize: "12px", fontWeight: 600, fontFamily: "DM Sans, sans-serif", letterSpacing: "0.06em" }}>LOGO</span>
              </div>
            )}
          </div>
        )}

        {/* Spacer — smaller above to push group upward */}
        <div style={{ flex: 0.3 }} />
        ...
        {vis.showNarrator && (
          <p style={{
            ...
            color: fs.narrator.color,
            textAlign: fs.narrator.textAlign as React.CSSProperties["textAlign"],
        ...
        <p ref={hadisRef} style={{
          ...
          textAlign: fs.hadisText.textAlign as React.CSSProperties["textAlign"],
        ...
        {/* Spacer — larger below to absorb remaining space */}
        <div style={{ flex: 0.7 }} />
                  ...
                  {item.type === "instagram" && (
                    footerIconColor === "colored" ? (
                      <svg width="14" height="14" fill="none" viewBox="0 0 24 24">
                        <defs><radialGradient id={`ig-isl-${id}`} cx="30%" cy="107%" r="1.5"><stop offset="0%" stopColor="#ffd676" /><stop offset="10%" stopColor="#f9a12e" /><stop offset="50%" stopColor="#e1306c" /><stop offset="90%" stopColor="#833ab4" /></radialGradient></defs>
                        <rect width="24" height="24" rx="6" fill={`url(#ig-isl-${id})`} />
