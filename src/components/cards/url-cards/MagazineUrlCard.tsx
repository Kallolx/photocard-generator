...
function getTextShadow(
  ...
  switch (preset) {
    ...
    case "outline":
      return isLight
        ? `${offsetX}px ${offsetY}px 0px rgba(0, 0, 0, 0.9), ${-offsetX}px ${-offsetY}px 0px rgba(0, 0, 0, 0.9), ${offsetY}px ${-offsetX}px 0px rgba(0, 0, 0, 0.9), ${-offsetY}px ${offsetX}px 0px rgba(0, 0, 0, 0.9)`
        : `${offsetX}px ${offsetY}px 0px rgba(255, 255, 255, 0.9), ${-offsetX}px ${-offsetY}px 0px rgba(255, 255, 255, 0.9), ${offsetY}px ${-offsetX}px 0px rgba(255, 255, 255, 0.9), ${-offsetY}px ${offsetX}px 0px rgba(255, 255, 255, 0.9)`;
    default:
      return "none";
  }
}
    ...
    >
      <div className="relative overflow-hidden">
        ...
        <div className="absolute left-15 top-[70px] -translate-x-1/2 z-30">
          <div
            className="relative bg-white rounded-full border-2 shadow-lg flex items-center justify-center border-gray-200"
            style={{
              width: "45px",
              height: "45px",
            }}
                  ...
                  <span className="shrink-0">
                    {item.type === "facebook" && (
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        style={{
                          color: footerIconColor === "colored" ? "#1877f2" : "#fff",
                        }}
                      >
                    ...
                    {item.type === "youtube" && (
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        style={{
                          color: footerIconColor === "colored" ? "#ff0000" : "#fff",
                        }}
                      >
                    ...
                    {item.type === "twitter" && (
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        style={{
                          color: footerIconColor === "colored" ? "#1d9bf0" : "#fff",
                        }}
                      >
                    ...
                    {item.type === "tiktok" && (
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        style={{
                          color: footerIconColor === "colored" ? "#EE1D52" : "#fff",
                        }}
                      >
                    ...
                    {item.type === "website" && (
                      <svg
                        className="w-3.5 h-3.5"
                        fill="none"
                        stroke={footerIconColor === "colored" ? "#8b6834" : "white"}
                        viewBox="0 0 24 24"
                      >
                        <path
                          strokeLinecap="round"
