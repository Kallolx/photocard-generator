...
interface ModernCustomCardProps {
  data: PhotocardData;
...
export default function ModernCustomCard({
  data,
  isGenerating,
  background,
  id = "photocard",
    ...
    switch (elementType) {
        ...
        return (
          ...
          >
            <div className="flex items-center">
              <div className="bg-white rounded-lg border border-gray-200 p-2 min-w-[60px] min-h-[30px] shadow-lg flex items-center justify-center">
                {data.logo ? (
                  <img
                    src={data.logo}
                    alt="Site logo"
      ...
      case 'dateWeek':
        ...
        return (
          ...
          >
            <div
              className="text-white font-noto-bengali tracking-wide px-3 py-1 rounded shadow-lg text-center"
              style={{
                ...getBackgroundStyle(),
                fontSize: fontStyles?.week.fontSize || "14px",
                fontWeight: fontStyles?.week.fontWeight || "500",
    ...
    <DndContext onDragStart={handleDragStart} onDragEnd={handleDragEnd}>
      ...
      >
        ...
        >
          ...
          {/* Overlay: Logo and Date on top of image - swappable positions */}
      ...
      <div className="px-6 pt-4 pb-4 relative z-10">
        ...
        {visibilitySettings.showTitle && (
          <h2 
            className="text-white text-2xl text-center font-bold mb-3 leading-tight font-noto-bengali px-2 py-1"
            style={{
