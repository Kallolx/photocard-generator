  ...
  return (
    ...
    >
      <div className="px-6 pt-6 pb-2">
        ...
        {/* QR Code and Website Info - Hidden when hideFooter is true */}
        {!hideFooter && (
          <div className="flex items-start justify-between gap-4 mt-0">
            ...
            {/* Quote SVG - Side by side with QR code */}
            {!hideQuote && (
              <div className="flex-shrink-0">
                <svg 
                  className="w-20 h-20 text-white/40 drop-shadow-lg" 
                  fill="currentColor" 
                  viewBox="0 0 24 24"
                >
      ...
      {/* Social Media Footer - Only for custom cards */}
      ...
      {/* Ad Banner - Full width at bottom, double footer height */}
      {adBannerImage && (
